...
import (
	...
	"movieapp.github.com.katarzynakawala/internal/mailer"
)
...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "db-dsn", "postgres://movieapp:password@localhost/movieapp?sslmode=disable", "PostgreSQL DSN")
